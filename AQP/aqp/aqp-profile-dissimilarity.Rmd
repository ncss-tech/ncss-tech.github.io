...
par(mar=c(1,1,1,1))
# profiles
plotSPC(d, name='name', axis.line.offset = -1)
...
tps <- list(superpose.line=list(col=cols, lwd=2, lty=c(1,2,4)), strip.background=list(col=grey(0.85)))
# render figure
print(update(p.3, par.settings=tps))
```
