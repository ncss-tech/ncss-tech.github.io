...
Simulate moist color sequences using Markov chains derived from transition probability matrix.
```{r fig.width=8, fig.height=5}
...
munsell.sequence <- replicate(30, rmarkovchain(n = 10, object = mc, include.t0 = TRUE, t0 = "7.5YR 3/2"))
...
Additional ideas...
```{r}
conditionalDistribution(mc, '7.5YR 3/2')
mostLikelyHzSequence(mc, t0 = "7.5YR 3/2")
```
