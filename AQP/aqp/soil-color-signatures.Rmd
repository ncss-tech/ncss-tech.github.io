...
pig <- soilColorSignature(s, method = 'pam', pam.k = 3)
...
plotProfileDendrogram(s, dd, dend.y.scale = max(d) * 2, scaling.factor = 0.33, y.offset = 2, width=0.4, name = NA, dend.color = 'white', dend.width = 2, divide.hz=FALSE, print.id=FALSE, plot.depth.axis=FALSE)
```
