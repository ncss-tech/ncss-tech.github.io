...
par(mar = c(0, 0, 0, 1))
plotSPC(sp1, width = 0.3, name.style = 'center-center')
...
plotProfileDendrogram(sp1, clust = dd, dend.y.scale = 0.25, scaling.factor = 0.0008, y.offset = 0.02, width = 0.3, name.style = 'center-center')
```
...
par(mar=c(0,0,1,1))
plotProfileDendrogram(s, dd, dend.y.scale = max(d) * 2, scaling.factor = 0.003, y.offset = 0.05, width = 0.33, cex.names = 0.45, shrink = TRUE, name.style = 'center-center')
```
...
par(mar=c(0,0,1,1))
plotProfileDendrogram(s, dd, dend.y.scale = max(d) * 2, scaling.factor = 0.3, y.offset = 5, width = 0.33, cex.names = 0.45, shrink = TRUE, name.style = 'center-center')
```
...
par(mar=c(0,0,1,1))
plotProfileDendrogram(s, dd, dend.y.scale = max(d) * 2, scaling.factor = 0.3, y.offset = 3, width = 0.33, cex.names = 0.45, shrink = TRUE, name.style = 'center-center')
```
...
par(mar=c(0,0,1,1))
plotProfileDendrogram(s, dd, dend.y.scale = max(d) * 2, scaling.factor = 0.45, y.offset = 5.5, width = 0.33, cex.names = 0.45, shrink = TRUE, name.style = 'center-center')
```
...
plotProfileDendrogram(s, dd, dend.y.scale = max(d) * 2, scaling.factor = 0.33, y.offset = 1.5, width=0.4, name = NA, dend.color = 'white', dend.width = 2, divide.hz=FALSE, print.id=FALSE, plot.depth.axis=FALSE)
```
