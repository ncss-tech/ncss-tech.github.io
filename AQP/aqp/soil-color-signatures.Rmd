...
plotSPC(s, y.offset = yoff, relative.pos = xoff, width = 0.25, name.style = 'center-center', hz.depths = FALSE, col.label = 'Generalized Horizon Label', print.id = TRUE, name = NA, scaling.factor = 0.5, shrink = TRUE)
```
