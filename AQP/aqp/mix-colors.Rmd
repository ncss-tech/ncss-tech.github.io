...
```{r fig.height=5.5, fig.width=9}
plotColorMixture(c('10YR 6/2', '5YR 5/6'), swatch.cex = 5, mixingMethod = 'reference', showMixedSpec = TRUE)
...
```{r fig.height=5.5, fig.width=9}
plotColorMixture(c('5B 5/10', '5Y 8/8'), swatch.cex = 4, label.cex = 0.65, showMixedSpec = TRUE, mixingMethod = 'reference', n = 3)
```
