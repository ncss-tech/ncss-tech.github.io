...
## TODO: consider further subsetting to specific hues

# only create pair-wise combinations for available spectra
# 2442 chips
...
# expand distance matrix to full form
m <- as.matrix(d)

# extract pair-wise distances for adjacent chips only
...
plot(d.adj, cc$dE00, type = 'n', xlab = 'Spectral Distance', ylab = expression(~Delta*E['00']), col.axis = 'white', col.lab = 'white', axes = FALSE)
grid()
points(d.adj, cc$dE00, pch = 15, col = as.numeric(x.comb$code) + 1, cex = 0.5)

axis(side = 1, col.axis = 'white')
axis(side = 2, at = 0:15, col.axis = 'white', las = 1, cex.axis = 0.75)
title('Adjacent Munsell Chips', col.main = 'white')

legend('bottomright', legend = levels(x.comb$code), pch = 15, col = 2:4, bty = 'n')
