...
Compare "reference" (default) vs. "exact" mixing methods.
```{r fig.height=5.5, fig.width=9}
plotColorMixture(c('10YR 6/2', '5YR 5/6'), swatch.cex = 5, showMixedSpec = TRUE)
plotColorMixture(c('10YR 6/2', '5YR 5/6'), swatch.cex = 5, mixingMethod = 'exact')
```
...
```{r fig.height=5.5, fig.width=9}
plotColorMixture(c('5B 5/10', '5Y 8/8'), swatch.cex = 4, label.cex = 0.65, showMixedSpec = TRUE, mixingMethod = 'reference')
plotColorMixture(c('5B 5/10', '5Y 8/8'), swatch.cex = 4, label.cex = 0.65, mixingMethod = 'exact')
```
