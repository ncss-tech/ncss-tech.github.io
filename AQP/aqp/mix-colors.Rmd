...
Should the mixture of two `10YR` colors always result in a `10YR` mixture candidate? It seems like it should.
```{r}
...
```{r fig.height=5.5, fig.width=9}
plotColorMixture(c('10YR 8/6', '10YR 2/2'), swatch.cex = 5)
```
