...
## Updates 2016-08-17
A report that performs map unit comparisons is available [here](https://github.com/ncss-tech/soilReports).
...
## Map Unit Data
Map unit polygons can be loaded from shapefile, "file" geodatabase, [SDA](http://ncss-tech.github.io/AQP/soilDB/SDA-tutorial.html), or any other [OGR-compatible](http://www.gdal.org/) data source. When working with a large number of polygons it can be advantageous to work with a subset generated using an external GIS application. In this example, the subsetting operations is performed in R. Be sure to adjust the path below to point to a file containing map unit polygons.
 ...
 * **SDA** (polygons loaded from the live SSURGO data via Soil Data Access)
    ...
    + [examples here](http://ncss-tech.github.io/AQP/soilDB/SDA-tutorial-2.html)
...
raster.list <- list(maat=raster('E:/gis_data/prism/final_MAAT_800m.tif'), 
                    ppt=raster('E:/gis_data/prism/final_MAP_mm_800m.tif'),
                    wb=raster('E:/gis_data/prism/effective_precipitation_800m.tif'),
