...
This is close but not quite right. No accounting for leap years. Select percentiles of cumulative PPT by "water day" are not always monotonic functions.
```{r fig.height=5, fig.width=7}
