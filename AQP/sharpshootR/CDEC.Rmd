...
x <- CDECquery(id='NHG', sensor=45, interval='D', start='1900-01-01', end='2021-01-01')
summary(x$value)
head(x)
nrow(x)
```
...
pinecrest <- CDECquery(id='swb', sensor=15, interval='D', start='2015-01-01', end='2021-01-01')
new.melones <- CDECquery(id='nml', sensor=15, interval='D', start='2015-01-01', end='2021-01-01')
lyons <- CDECquery(id='lys', sensor=15, interval='D', start='2015-01-01', end='2021-01-01')
dp <- CDECquery(id='dnp', sensor=15, interval='D', start='2015-01-01', end='2021-01-01')
...
new.melones.monthly <- CDECquery(id='nml', sensor=15, interval='M', start='1900-01-01', end='2021-01-01')
