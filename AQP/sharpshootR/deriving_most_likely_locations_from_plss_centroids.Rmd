...
points(d1[idx.pt,], pch=15, cex=1, lwd=2)
...
# extract extent
e <- extent(sf::st_as_sf(p.plss$geom))
...
idx <- which(a5$distance < quantile(a5$distance)[2]*0.5)
plot(rs$elevation)
#plot(r1)
...
d6 <- join(d, coords.ml, by='id', type='left')
```
