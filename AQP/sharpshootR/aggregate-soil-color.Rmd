...
# graphical check
par(mar=c(0,0,0,4))
plot(loafercreek, name='', print.id=FALSE, cex.names=0.8, axis.line.offset=-1, max.depth=100, divide.hz=FALSE)
```
...
aggregateColorPlot(aggregateColor(sierra_transect, 'taxonname'), label.cex=0.65, main='Soil Color Signatures', print.n.hz = TRUE, rect.border = NA, print.label = FALSE, horizontal.borders = TRUE)

par(mar=c(4.5,5,4.5,0))
aggregateColorPlot(aggregateColor(sierra_transect, 'taxonname', k=8), label.cex=0.65, main='Soil Color Signatures', print.n.hz = TRUE, rect.border = NA, print.label = FALSE, horizontal.borders = TRUE)
```
