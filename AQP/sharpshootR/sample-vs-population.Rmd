 ...
 * cell size and extent: large rasters will take longer to sample, especially if the file cannot fit into available memory
...
Sampling implies stochasticity--each sampling event will result in a slightly different result. We can test the "stability" of sample-based estimates, like the median, via simulation.
