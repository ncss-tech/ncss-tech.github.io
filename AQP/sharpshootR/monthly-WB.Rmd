...
wb.sand <- monthlyWB(AWC.sand, PPT, PET, S_init = 0, starting_month = 1, rep = 5, keep_last = TRUE)
wb.loam <- monthlyWB(AWC.loam, PPT, PET, S_init = 0, starting_month = 1, rep = 5, keep_last = TRUE)

# compare
par(mar=c(4,4,4,1), bg = 'white', mfcol = c(1, 2))
plotWB(WB = wb.sand, AWC = AWC.sand)
title('50cm of sandy loam texture soil material', line = 3)

plotWB(WB = wb.loam, AWC = AWC.loam)
