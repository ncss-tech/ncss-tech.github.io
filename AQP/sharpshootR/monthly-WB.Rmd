...
wb.sand <- monthlyWB(AWC.sand, PPT, PET, S_init = 0, starting_month = 1, rep = 5, keep_last = TRUE, a.ss = 0)
wb.loam <- monthlyWB(AWC.loam, PPT, PET, S_init = 0, starting_month = 1, rep = 5, keep_last = TRUE, a.ss = 0)
```

```{r fig.width=16, fig.height=6.5}
# compare
par(mar=c(4,4,4,1), bg = 'white', mfcol = c(1, 2))
plotWB(WB = wb.sand, legend.cex = 0.75)
title('50cm of sandy loam texture soil material', line = 3)

plotWB(WB = wb.loam, legend.cex = 0.75)
...
# compare
par(mar=c(4,4,4,1), bg = 'white', mfcol = c(1, 2))
plotWB_lines(WB = wb.sand)
title('50cm of sandy loam texture soil material', line = 3)

plotWB_lines(WB = wb.loam)
title('50cm of silt loam texture soil material', line = 3)
```
