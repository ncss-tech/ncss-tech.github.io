...
Join us for a workshop from 4:15-5:15pm on Monday June 10th where we will review the Algorithms for Quantitative Pedology (AQP) suite of R packages for soil data retrieval, analysis, and visualization. Bring your computer, ideally with the latest versions of [R](https://cran.r-project.org/) and [RStudio](https://www.rstudio.com/products/rstudio/download/#download) installed ahead of time. 
...
# Workshop Outline
   ...
   * 15 minutes: worked examples with discussion of methods / interpretation (how)
   * 30 minutes: Q&A, detailed discussion of methods, assistance with applying to own data or running some of the many tutorials
...
packages <- c(
  ...
  # graphics
  "latticeExtra", "Cairo", "maps", "plotrix", "dendextend",
  # modeling
  "car", "rms", "vegan", "ape",
  # sampling
  "clhs"
