...
has_sandy_cambic <- function(p, sandy.texture.pattern = "SR|-S$|^S$|COS$|L[^V]FS$|[^L]VFS$|LS$|LFS$") {
  ...
  if(!is.null(cambic_top) | !is.null(cambic_bot)) {
    ...
    #TODO: we add 1 because glom() is greedy and will include the overlying horizon by default
    # if z1 is a horizon boundary. as.data.frame because single horizon SPCs cause errors
