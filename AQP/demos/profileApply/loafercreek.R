...
#' 
#' ![A photo of a Loafercreek soil profile. NASIS UserpedonID: 09BAH008](images/loafercreek-09BAH008.jpg)
#' 
...
#' 
#' ![Thermic metavolcanic foothills landscape photo](images/CA630_keystonequad_rushingmtn_tower6.JPG)
#' 
...
#' 
#' By changing the default settings of  `estimateSoilDepth()` you can calculate many "depth-to-_X_" features involving a _character_ or categorical variables that are contained within horizon designations (`hzname`). 
#' 
...
#' 
#' The less than 40 cm group looks pretty good. Not too many gaps in the data, and our criteria are met. And we have `r nrow(site(sub1))` pedons in the group.
#' 
## ------------------------------------------------------------------------
...
#' 
#' We will use quantiles to summarize the distribution of `maxclay` for our three different redness groups and compare these values to the smoothed slab-wise quantiles derived above.
#' 
## ------------------------------------------------------------------------
...
#' 
#' The _median_ we calculate above for each group using aggregate() is not considering horizon thickness. These medians show larger differences between groups than we found in the slab-wise analysis. This make sense, because all obseravations have equal weight in the above aggregate call, whereas slab effectively weights them based on their depths relative to the user defined slab structure.
#' 
