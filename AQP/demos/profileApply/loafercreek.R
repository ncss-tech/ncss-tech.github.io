...
#' 
#' ![A typical photo of a Loafercreek soil profile. NASIS UserPedonID: 09BAH008](images/loafercreek-09BAH008.jpg)
#' 
...
#' 
#' Setting the margins equal to zero (e.g. `par(mar=c(0,0,0,0))`) can sometimes help with displaying plots with either small (5 or less) or large (40+) numbers of profiles. This is a byproduct of some of the limitations of the base R graphics system.
#' 
