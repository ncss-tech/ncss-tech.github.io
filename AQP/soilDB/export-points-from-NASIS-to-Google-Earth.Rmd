...
s$report_link <- paste(']]><![CDATA[<a href="https://nasis.sc.egov.usda.gov/NasisReportsWebSite/limsreport.aspx?report_name=Pedon+Description+html+(userpedid)&pedon_id=', s$pedon_id, '">Pedon Description Report</a>]]><![CDATA[', sep='')

kml_file_path <- 'C:/temp/R_sites_with_report_link1.kml'
