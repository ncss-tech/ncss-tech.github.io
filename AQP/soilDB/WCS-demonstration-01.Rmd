...
# extract metadata for figure label
# see subsection below for details
.md <- metags(mu)
.title <- sprintf("%s (%s)", .md$value[1], .md$value[2])
plot(mu, legend = FALSE, axes = FALSE, main = .title)
...
.md <- metags(x)
.title <- sprintf("%s (%s)", .md$value[1], .md$value[2])
plot(x, axes = FALSE, legend = FALSE, main = .title)
# original BBOX
plot(a, add = TRUE)
...
.md <- metags(y)
.title <- sprintf("%s (%s)", .md$value[1], .md$value[2])
plot(y, axes = FALSE, legend = FALSE, main = .title)
# original BBOX
plot(a, add = TRUE)
...
.md <- metags(z)
.title <- sprintf("%s (%s)", .md$value[1], .md$value[2])
plot(z, axes = FALSE, legend = FALSE, main = .title, ext = x)
# original BBOX
plot(a, add = TRUE)
```
...
.md <- metags(statsgo)
.title <- sprintf("%s (%s)", .md$value[1], .md$value[2])
plot(statsgo, axes = FALSE, legend = FALSE, main = .title)
```
...
# format title from metadata
.md <- metags(mu)
.title <- sprintf("%s (%s)", .md$value[1], .md$value[2])

# make NA (the ocean) blue
plot(mu, legend = FALSE, axes = FALSE, main = .title, colNA = 'royalblue')
...
# TODO: better desdcribe missing colors
...
# color table is pre-set by soilColor.wcs()
plot(s, legend = FALSE, axes = FALSE, main = .title)
```
