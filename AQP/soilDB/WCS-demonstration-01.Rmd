...
plot(series_name, col = rat.new$soil_color, axes = FALSE, legend = FALSE, main = 'Moist Soil Colors at 25cm', sub = 'Source: most frequent series / 800m cell and OSDs')
```
