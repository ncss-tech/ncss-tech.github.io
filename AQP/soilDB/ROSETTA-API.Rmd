...
The ROSETTA model relies on a minimum of 3 soil properties, with increasing (expected) accuracy as additional properties are included:
  ...
  * optional, bulk density (any moisture basis): mass per volume after accounting for >2mm fragments, units of $gram/cm^3$
...
# andosoils usually have higher bulk densities (1.3–1.7 g/cm3) than fine silts and clays (1.1 – 1.6 g/cm3) because they have larger, but fewer, pore spaces. ... Soils rich in organic matter (e.g. peaty soils) can have densities of less than 0.5 g/cm3.
