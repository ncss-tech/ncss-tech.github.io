...
Average soil hydraulic parameters by USDA soil texture class, extracted from the [ROSETTA documentation](https://www.ars.usda.gov/pacific-west-area/riverside-ca/agricultural-water-efficiency-and-salinity-research-unit/docs/model/rosetta-class-average-hydraulic-parameters/).
...
xyplot(
  ...
  as.table=TRUE,
  main='van Genuchten Model Parameters fit by USDA-ARS Rosetta', 
  sub='Class Avergages'
)
```
