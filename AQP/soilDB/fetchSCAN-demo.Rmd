...
# this is a convenient way to access lab data for these depths
...
text(x=rep(lsp$x0, times=length(sensor.depths)), y=sensor.depths, labels = sensor.depths, cex=0.75, pos=1)
```
