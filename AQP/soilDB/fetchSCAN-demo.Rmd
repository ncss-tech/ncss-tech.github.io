...
plot(s, name='hzn_desgn', label='pedon_id', id.style='top', cex.names=0.75, x.idx.offset=0.5, axis.line.offset=-15)
...
plot(s1, width=0.005, name='hzn_top', label='pedon_id', print.id=FALSE, id.style='top', cex.names=0.75, x.idx.offset=0.5, lwd=2, fill='blue', plot.depth.axis=FALSE, add=TRUE)
```
...
kable(horizons(s)[, c('hzn_desgn', 'hzn_top', 'hzn_bot', 'theta_r', 'theta_s', 'alpha', 'npar')])
```
