...
You will probably have to modify the filtering expressions below to match the specifics of your selected set.
...
f.1 <- fetchNASIS(from='pedons', nullFragsAreZero = FALSE)

# assume NULL fragment volume is NULL
f.2 <- fetchNASIS(from='pedons', nullFragsAreZero = TRUE)
