...
# using moist soil colors, automatically converted from Munsell -> sRGB
# by fetchOSD()
pig <- soilColorSignature(spc, color = 'soil_color', method = 'pam', pam.k = 3)
...
Re-make, this time as a work of art.
...
aqp::plotProfileDendrogram(spc, dd, dend.y.scale = max(d) * 2, scaling.factor = 0.33, y.offset = 2, width = 0.4, cex.names = 0.45, dend.color = 'white', dend.width = 2, divide.hz = FALSE, print.id = FALSE, depth.axis = FALSE, name=NA, default.color = grey(0.125), max.depth = 180, dend.type = 'cladogram')
