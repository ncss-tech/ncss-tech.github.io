...
```{r}
s <- fetchOSD('Drummer', extended = TRUE)
```

Invoke `fetchOSD` for all series that share family-level classification with Drummer.
```{r}
# get competing series OSD data
spc <- fetchOSD(c('DRUMMER', s$competing$competing))
