...
plotSPC(spc, name.style = 'center-center', width = 0.3)
...
par(mar=c(1,0,1,1))
plotProfileDendrogram(spc, dd, dend.y.scale = max(d) * 2, scaling.factor = 0.3, y.offset = 2, width=0.2, cex.names=0.45)
...
plotProfileDendrogram(spc, dd, dend.y.scale = max(d) * 2, scaling.factor = 0.3, y.offset = 2, width=0.4, cex.names=0.45, dend.color = 'white', dend.width = 2, divide.hz=FALSE, print.id=FALSE, plot.depth.axis=FALSE, name=NA, default.color = grey(0.125))
