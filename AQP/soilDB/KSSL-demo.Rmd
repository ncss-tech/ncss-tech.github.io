...
# check
par(mar=c(0,0,0,0))
plotSPC(pedons, color='moist_soil_color', print.id=FALSE, name='hzn_desgn', width = 0.3)
```
...
# check
par(mar=c(0,0,3,0))
plotSPC(pedons, color='total_frags_pct', print.id=FALSE, name='hzn_desgn', width = 0.3)
...
# check: looks good
plotSPC(pedons, color='estimated_ph_h2o', name='hzn_desgn', label = 'pedlabsampnum')

# check: looks good
plotSPC(pedons, color='moist_soil_color', name='hzn_desgn', label = 'pedlabsampnum')
```
