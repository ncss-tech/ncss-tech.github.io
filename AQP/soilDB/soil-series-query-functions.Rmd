...
Hillslope position (2D) and geomorphic component (3D) probabilities have been estimated by series by dividing the number of components assigned the each hillslope position or geomorphic component by the total number of components. The total number of components and Shannon entropy are also included in the summary.
```{r echo=FALSE}
