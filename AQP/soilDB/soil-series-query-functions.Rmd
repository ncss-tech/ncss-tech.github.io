...
par(mar=c(0,0,1,1))
SoilTaxonomyDendrogram(s, scaling.factor = 0.02, width = 0.28, name.style = 'center-center')
```
...
SoilTaxonomyDendrogram(h, y.offset = 0.4, width = 0.3, name.style = 'center-center')
```
...
par(mar=c(0,0,1,1))
SoilTaxonomyDendrogram(s, y.offset = 0.4, scaling.factor = 0.0225, width = 0.28, name.style = 'center-center')
```
...
par(mar=c(0,0,1,1))
SoilTaxonomyDendrogram(s, width=0.3, scaling.factor = 0.02)
```
...
par(mar=c(0,0,1,1))
SoilTaxonomyDendrogram(s, y.offset = 0.4, width=0.3, scaling.factor = 0.02, shrink = TRUE)
```
...
par(mar=c(0,0,1,1))
SoilTaxonomyDendrogram(s$SPC, y.offset = 0.4, width=0.3, scaling.factor = 0.02, shrink = TRUE)
...
```{r fig.width=10, fig.height=6, echo=FALSE}
par(mar=c(0, 0, 2, 0))
plotSPC(s$SPC, plot.order = res$order, name.style = 'center-center', cex.names = 0.66, hz.depths = TRUE, hz.depths.offset = 0.05, fixLabelCollisions = TRUE, plot.depth.axis = FALSE)
...
```{r fig.width=10, fig.height=6, echo=FALSE}
par(mar=c(0, 0, 2, 0))
plot(s$SPC, plot.order = res$order, name.style = 'center-center', cex.names = 0.66, hz.depths = TRUE, hz.depths.offset = 0.05, fixLabelCollisions = TRUE, plot.depth.axis = FALSE)
title('Hydrologic Ordering via Geomorphic Component Proportions')
```

```{r fig.width=10, fig.height=6, echo=FALSE}
par(mar=c(0,0,1,1))
SoilTaxonomyDendrogram(s$SPC, y.offset = 0.4, scaling.factor = 0.015, name.style = 'center-center', cex.names = 0.66, hz.depths = TRUE, hz.depths.offset = 0.05, fixLabelCollisions = TRUE, plot.depth.axis = FALSE, width = 0.28)
```
