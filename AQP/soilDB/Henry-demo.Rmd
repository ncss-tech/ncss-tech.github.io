...
x <- fetchHenry(project='NorthernNY_watertable')

# basic plot, each panel is a well
...
3. Fit a simple model relating MAST to MAAT (PRISM) using soil temperature data from the 2-SON office.
```{r, results='hide'}
library(raster)
library(rms)
