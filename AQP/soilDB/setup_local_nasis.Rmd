...
![](odbc-06.png)
  ...
  + Your computer name will look something like: `CASONORA00L354` -- where state, office and number will vary from computer to computer.
  
  + So, in summary, you will have something like _Server:_ `CASONORA00L354\NASISSQLEXPRESS` entered on the form pictured below.
